...
client.on("messageCreate", async msg => {
  switch (msg.content) {
    ...
    case ".jimmerhelp":
      msg.channel.send("Commands (use prefix '"+prefix+"'):")
      msg.channel.send("generate: sends three randomly generated passwords of different types to your DMs")
      msg.channel.send("vote #: votes for option # if there is an ongoing vote.")
      break;
    case ".bartest":
